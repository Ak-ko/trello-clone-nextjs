    ...
    return (
        (dateRange?.from || dateRange?.to) && (
            <div className="text-sm">
                <span className="text-xs font-bold block">Dates</span>
                <div className="bg-primary/10 font-bold shadow-primary/20 shadow text-primary px-3 py-1 inline-flex items-center gap-2">
                    {dateRange?.from && (
